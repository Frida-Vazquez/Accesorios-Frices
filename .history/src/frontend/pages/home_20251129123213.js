...
import { renderPage } from "../layout/mainpage.js";   // ← AQUÍ VA EL IMPORT CORREGIDO
  ...
  const content = `
    ...
    <section class="grid sm:grid-cols-2 md:grid-cols-3 gap-6">
      <div class="bg-white rounded-2xl shadow hover:shadow-lg transition p-4">
        <img src="/static/logo.png" class="w-full h-40 object-contain mb-3" alt="Producto">
        ...
        <button class="mt-3 w-full bg-rose-500 text-white py-1.5 rounded-xl hover:bg-rose-400 transition">Ver más</button>
      </div>
