...
const CARRITO_KEY = "frices_carrito"; // 👈 carrito en localStorage
...
// ========== RENDER DE PRODUCTOS (con corazoncito y botón Agregar) ==========
  ...
  lista.forEach((p) => {
    ...
    if (btnAgregar) {
      btnAgregar.addEventListener("click", (e) => {
        e.stopPropagation();
        agregarAlCarrito(p); // 👈 usamos el producto completo
      });
    }
