...
// 🔁 MISMA FUNCIÓN slugify QUE EN cliente.js
...
async function cargarCategoriaYProductos() {
  try {
    // 1) Traer todas las categorías (las mismas que ves en admin)
    ...
    // 2) Buscar la categoría cuyo slug coincide con la URL
    ...
    // 4) Pedir productos filtrados por id de categoría
